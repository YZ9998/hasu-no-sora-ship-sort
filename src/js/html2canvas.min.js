...
!function(A, e) {
    ...
    , function(A, e, t) {
        ...
        var r, n = function() {
            ...
            default: r
        }, s = t(4), o = t(5), i = t(12), c = t(33), l = t(34), u = t(35), Q = t(36), w = t(37), U = t(38), g = t(8), C = t(39), d = t(40), F = t(18), E = t(17), f = t(19), h = t(11), H = t(41), p = t(20), N = t(42), I = t(43), K = t(44), T = t(45), m = t(1), v = t(21), y = t(14);
    ...
    , function(A, e, t) {
        ...
        var r, n = t(2), B = (r = n) && r.__esModule ? r : {
            default: r
        };
        e.PADDING_SIDES = {
            TOP: 0,
    ...
    , function(A, e, t) {
        ...
        var r, n = t(1), B = t(11), a = t(10), s = (r = a) && r.__esModule ? r : {
            default: r
        }, o = t(24);
    ...
    , function(A, e, t) {
        ...
        var i = function(A, e) {
            var t = e || {}
              , o = new B.default("boolean" != typeof t.logging || t.logging);
            ...
            var c = i.defaultView
              , l = c.pageXOffset
              , u = c.pageYOffset
              , Q = "HTML" === A.tagName || "BODY" === A.tagName ? (0,
            s.parseDocumentSize)(i) : (0,
            s.parseBounds)(A, l, u)
              , w = Q.width
              , U = Q.height
              , g = Q.left
              ...
              , F = (0,
            a.renderElement)(A, r({}, d, t), o);
            return F
        };
        i.CanvasRenderer = n.default,
        A.exports = i
    }
    , function(A, e, t) {
        "use strict";
        ...
        e.renderElement = function A(e, t, Q) {
            ...
            return (t.foreignObjectRendering ? s.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(!1)).then(function(s) {
                ...
                i.cloneWindow)(w, U, e, t, Q, A).then(function(A) {
                    ...
                    n.NodeParser)(s, o, Q)
                      , u = s.ownerDocument;
                    return d === i.container.style.background.backgroundColor && (i.container.style.background.backgroundColor = l.TRANSPARENT),
    ...
    , function(A, e, t) {
        ...
        var i = function() {
            ...
            return n(A, [{
                ...
                value: function(A) {
                    var e = this;
                    return w(A) ? C(A, this.options.imageTimeout || 0) : this.hasResourceInCache(A) ? this.cache[A] : this.isSameOrigin(A) || "string" != typeof this.options.proxy ? this.xhrImage(A) : this.cache[A] = (0,
                    s.Proxy)(A, this.options).then(function(A) {
                        return C(A, e.options.imageTimeout || 0)
                    })
                }
                ...
                value: function(A, e, t) {
                    ...
                    return this.cache[A] = U(e) && !g(e) ? a.default.SUPPORT_BASE64_DRAWING(e).then(n) : n(!0),
                    A
                }
            }, {
                key: "isSameOrigin",
